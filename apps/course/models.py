...
class Course(models.Model):
    ...
    teacher = models.ForeignKey(Teacher,on_delete=models.CASCADE,verbose_name='授课教师', null=True, blank=True)
    ...
    tag = models.CharField('课程标签', default='Python', max_length=10)
    youneed_know = models.CharField("课程须知", max_length=300,default='')
    teacher_tell = models.CharField("老师提醒", max_length=300,default='')
...
class Video(models.Model):
    ...
    add_time = models.DateTimeField("添加时间", default=datetime.now)
    video_times = models.IntegerField("课程时长(分钟数)", default=0)
    class Meta:
        verbose_name = "视频"
        verbose_name_plural = verbose_name
